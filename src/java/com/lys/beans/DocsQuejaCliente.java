...
public class DocsQuejaCliente {
    ...
    public DocsQuejaCliente(String c_compania, int n_queja, int n_linea, String c_descripcion, String c_nombre_archivo, String c_ruta_archivo, String d_ultimafechamodificacion) {
