...
public class DocsCapacitacion {
    ...
    public DocsCapacitacion(String c_compania, int n_solicitud, int n_linea, String c_descripcion, String c_nombre_archivo, String c_ruta_archivo, String c_ultimousuario, String d_ultimafechamodificacion) {
